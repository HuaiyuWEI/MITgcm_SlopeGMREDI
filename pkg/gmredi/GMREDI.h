...
#ifdef ALLOW_GM_ML
C     In gmredi_calc_ML.F we also calculate Reynolds stress over 
C     continental slopes and store it as a globle parameter. 
C     Later the divergence of the stress will be added as an external  
